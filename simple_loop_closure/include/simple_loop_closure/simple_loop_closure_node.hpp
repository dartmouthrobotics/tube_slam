...
private: 
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr constructPointCloudMap(const int interval = 0);
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr constructTargetCloud(const int target_id);

    pcl::PointCloud<pcl::PointXYZ>::Ptr constructSourceCloud(const int source_id);
