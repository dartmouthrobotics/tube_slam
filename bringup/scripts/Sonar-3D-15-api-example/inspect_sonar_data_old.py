...
if __name__ == "__main__":
    ...
    pc2_pub = rospy.Publisher('/sonar_3d/kiss_icp/pointcloud', PointCloud2, queue_size=10)
    pointcloud_sub = rospy.Subscriber('/sonar_3d/point_cloud', PointCloud, pointcloud_callback)
